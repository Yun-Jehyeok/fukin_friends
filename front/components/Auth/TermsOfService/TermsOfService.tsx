...
import { ErrMsg, TOSBox, TOSButton, TOSButtonContainer, TOSContainer, TOSLabel, TOSLastLabel, TOSLogo, TOSWrap } from './style';
  ...
  return (
    <TOSContainer>
      <TOSWrap>
        ...
        <div>
          <TOSLabel>
            <span onClick={onClickFirstTOS}>
              <Image src={firstCheck ? check : noCheck} alt="non-check" width={24} height={24} />
            </span>
            FUKIN FRIEND 이용 약관 동의 <span>(필수)</span>
          </TOSLabel>
          <TOSBox>
            1. 목적 : 지원자 개인 식별, 지원의사 확인, 입사전형의 진행, 고지사항 전달, 입사 지원자와의 원활한 의사소통, 지원이력 확인 및 면접 불합격자 재지원 제한<br/><br/>
        ...
        <div>
          <TOSLabel>
            <span onClick={onClickSecondTOS}>
              <Image src={secondCheck ? check : noCheck} alt="non-check" width={24} height={24} />
            </span>
        ...
        <TOSLastLabel>
          * 위 개인정보 수집에 대한 동의를 거부할 권리가 있으며, <span>FUKIN FRIENDS 이용이 제한될 수 있습니다.</span><br/>
        </TOSLastLabel>
        {errMsg ? <ErrMsg>FUKIN FRIENDS 이용약관과 개인정보 수집 및 이용 모두 동의해주세요.</ErrMsg> : ''}
        <TOSButtonContainer>
