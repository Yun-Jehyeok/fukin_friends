...
const CreateGroup: NextPage = () => {
    ...
    const changePassword = useCallback((e: React.FormEvent<HTMLFormElement>) => {
        e.preventDefault();
        ...
        if (!reg.test(password.value)) {
            ...
            setPasswordErrMsg("* 비밀번호는 최소 8자 이상, 문자와 숫자 조합이어야 합니다.")
        } else {
            ...
            if (password.value === passwordCheck.value) {
                ...
                setPasswordCheckErrMsg("* 비밀번호 확인란은 비밀번호와 같아야 합니다.")
            }
        }
            ...
            <PwInquiryForm>
                <div>
                    <form onSubmit={changePassword}>
                        ...
                        <AuthInput type="password" name="passwordCheck" placeholder="비밀번호 확인을 입력하세요" {...passwordCheck} />
                        {isPasswordCheckErr ? (
                            <AuthInputErrMsg>
                                {passwordCheckErrMsg}
                            </AuthInputErrMsg>
